...
\title[Logic route to strong AI]{{\Huge ``Easy'' presentation} \\ \vspace*{0.4cm} The logic route to strong AI}
...
\begin{itemize}
	...
	Sutton expressed the view that AI can probably be solved merely by \textbf{increasing computing power}, under the reinforcement learning framework
	}
	\begin{equation}
