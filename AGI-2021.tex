...
An integration of deep learning and logic is proposed, based on the Curry-Howard isomorphism.  Under this interpretation, it turns out that Google's BERT, where current state-of-the-art language models are derived from, can be regarded as a special form of logic.  Furthermore, this structure can be incorporated into a reinforcement-learning framework to provide a minimalist AGI architecture. 
...
As the risk of being overly rudimentary, we would go over some basic ideas, that may help the readers who are not familiar with this area of mathematics.

The Curry-Howard isomorphism

Pair of pants, quantum logic, ...
...
\subsection{Neuroscience considerations}
