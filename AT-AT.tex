...
\begin{equation}
\vcenter{\hbox{\includegraphics[scale=0.7]{arm-muscles-anatomy.png}}}
\end{equation}

\section*{Steel wires as robotic muscles}

\begin{equation}
\vcenter{\hbox{\includegraphics[scale=1]{steel-wire-muscles.png}}}
\end{equation}

\section*{Programmatically controlled clutches}

\begin{equation}
\vcenter{\hbox{\includegraphics[scale=1]{program-controlled-clutches.png}}}
\end{equation}

\section*{Single driving-shaft, multiple clutches}

\begin{equation}
\vcenter{\hbox{\includegraphics[scale=1]{single-shaft-multi-clutch.png}}}
\end{equation}

\section*{AT-AT from Star Wars}

\begin{equation}
\vcenter{\hbox{\includegraphics[scale=1]{AT-AT.jpg}}}
\end{equation}
