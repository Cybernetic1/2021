...
The type $\forall r. (a \rightarrow r) \rightarrow r$ is also known as the \textbf{continuation-passing style} (CPS) of the type $a$.

Intuitively, CPS can be understand as saying that:  having a value is just as good as having a function that will give that value to a callback.
