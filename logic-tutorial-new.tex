...
Intuitively, CPS can be understood as that: having a value is just as good as having a function that will give that value to a callback.
...
There exists a \textbf{Kolmogorov translation} that converts a classical proposition to an intuitionistic proposition.  The Kolmogorov translation is a special case of CPS.
...
\vcenter{\hbox{
		\begin{tikzpicture}[scale=0.8]
		\node[label={[xshift=0em, yshift=-0.2em]\mbox{rain}}] (a) at (1,0) {\textbullet};
