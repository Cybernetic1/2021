...
\usebackgroundtemplate{
	...
	\definecolor{graygray}{rgb}{.867,0.867,0.867}
	{\color{graygray}\polygon*(-55,-90)(-55,15)(400,-25)(400,-80)}
	\end{picture}
}
\begin{frame}
\vspace*{2em}
...
\let\thefootnote\relax\footnotetext{Picture credits: (1) http://clipartmag.com/robot-hand-drawing (2) Swoop by Chiefticon, https://www.deviantart.com/chiefticon }
\end{frame}
